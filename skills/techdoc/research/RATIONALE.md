...
Most address 1918 literary prose — colloquialisms, "shall vs will", quotation
citation — and do not serve technical docs. The skill keeps the eight that map
onto clear technical writing.
...
own conventions — the skill's real differentiator:
...
| Bundled stdlib formatter, no third-party dep | Alignment/whitespace are mechanical and must be enforced, not hand-applied; stdlib Python keeps it portable |
